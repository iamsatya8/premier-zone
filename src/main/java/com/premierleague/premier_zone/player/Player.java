...
public class Player {
    ...
    public Player(String playerName, String nation, String position, Integer age, Integer matches_played, Integer starts, Double minutes_played, Double goals, Double assists, Double penalties_scored, Double yello_cards, Double red_cards, Double expected_goals, Double expected_assists, String team_name) {
    ...
    public Double getYello_cards() {
        return yello_cards;
    }

    public void setYello_cards(Double yello_cards) {
        this.yello_cards = yello_cards;
    }
